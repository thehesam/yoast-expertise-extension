...
function yoast_eeat_add_user_edit_fields($user) {
    ...
    <table class="form-table">
        <tr>
            <th><label for="eeat_alternatename">User's alternamte name</label></th>
            <td>
                <input type="text" name="eeat_alternatename" id="eeat_alternatename" value="<?php echo esc_attr(get_user_meta($user->ID, 'eeat_alternatename', true)); ?>" class="regular-text" />
                <p class="description">Enter the user's name in another language.</p>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <th><label for="eeat_otherone">Other Link</label></th>
            <td>
                <input type="text" name="eeat_otherone" id="eeat_otherone" value="<?php echo esc_attr(get_user_meta($user->ID, 'eeat_otherone', true)); ?>" class="regular-text" />
                <p class="description">Enter the user's other profile URL.</p>
            </td>
        </tr>
        <tr>
            <th><label for="eeat_othertwo">Other Link</label></th>
            <td>
                <input type="text" name="eeat_othertwo" id="eeat_othertwo" value="<?php echo esc_attr(get_user_meta($user->ID, 'eeat_othertwo', true)); ?>" class="regular-text" />
                <p class="description">Enter the user's other profile URL.</p>
            </td>
        </tr>
    </table>
...
function yoast_eeat_save_user_fields($user_id) {
    if (current_user_can('edit_user', $user_id)) {
        update_user_meta($user_id, 'eeat_alternatename', sanitize_text_field($_POST['eeat_alternatename']));
        update_user_meta($user_id, 'eeat_linkedin', sanitize_text_field($_POST['eeat_linkedin']));
        update_user_meta($user_id, 'eeat_twitter', sanitize_text_field($_POST['eeat_twitter']));
        update_user_meta($user_id, 'eeat_instagram', sanitize_text_field($_POST['eeat_instagram']));
        update_user_meta($user_id, 'eeat_expertise', sanitize_text_field($_POST['eeat_expertise']));
        update_user_meta($user_id, 'eeat_education', sanitize_text_field($_POST['eeat_education']));
        update_user_meta($user_id, 'eeat_youtube', sanitize_text_field($_POST['eeat_youtube']));
        update_user_meta($user_id, 'eeat_wikipedia', sanitize_text_field($_POST['eeat_wikipedia']));
        update_user_meta($user_id, 'eeat_medium', sanitize_text_field($_POST['eeat_medium']));
        update_user_meta($user_id, 'eeat_otherone', sanitize_text_field($_POST['eeat_otherone']));
        update_user_meta($user_id, 'eeat_othertwo', sanitize_text_field($_POST['eeat_othertwo']));
    }
}
add_action('personal_options_update', 'yoast_eeat_save_user_fields');
add_action('edit_user_profile_update', 'yoast_eeat_save_user_fields');


///////////////schema
function change_schema_person( $schema ) {
  $author_id = get_the_author_meta( 'ID' );
  $alternatename = get_the_author_meta( 'eeat_alternatename', $alternatename );
...
if ( ! empty( $alternatename ) ) {
  ...
  $otherone_url = get_the_author_meta( 'eeat_otherone', $author_id );
  $othertwo_url = get_the_author_meta( 'eeat_othertwo', $author_id );
  ...
  if ( ! empty( $otherone_url ) ) {
      $same_as[] = $otherone_url;
  }
  if ( ! empty( $othertwo_url ) ) {
      $same_as[] = $othertwo_url;
  }
...
function add_editor_to_article_schema($data) {
    ...
    $editor_alternatename = get_the_author_meta('eeat_alternatename', $editor_id);
    ...
    $editor_otherone_url = get_the_author_meta('eeat_otherone', $editor_id);
    $editor_othertwo_url = get_the_author_meta('eeat_othertwo', $editor_id);
    ...
    if (!empty($editor_otherone_url)) {
        $eurls[] = $editor_otherone_url;
    }
    if (!empty($editor_othertwo_url)) {
        $eurls[] = $editor_othertwo_url;
    }
    ...
    if ($editor_id) {
        $editor_schema = array(
            ...
            'name' => $editor_name,
            'url' => $editor_url,
            'alternateName' => $editor_alternatename,
...
function add_factchecker_to_article_schema($data) {
    ...
    $factchecker_alternatename = get_the_author_meta('eeat_alternatename', $factcheckerr_id);
    ...
    $factchecker_otherone_url = get_the_author_meta('eeat_otherone', $factchecker_id);
    $factchecker_othertwo_url = get_the_author_meta('eeat_othertwo', $factchecker_id);
    ...
    if (!empty($factchecker_otherone_url)) {
        $furls[] = $factchecker_otherone_url;
    }
    if (!empty($factchecker_othertwo_url)) {
        $furls[] = $factchecker_othertwp_url;
    }
    ...
    if ($factchecker_id) {
        $factchecker_schema = array(
            ...
            'url' => $factchecker_url,
            'alternateName' => $factchecker_alternatename,
    $factchecker_twitter_url = get_the_author_meta('eeat_twitter', $factcheckerr_id);,
